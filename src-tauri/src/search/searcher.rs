...
pub fn search_index(
    ...
    for (score, doc_addr) in top_docs {
        ...
        results.push(SearchResultDto {
            ...
            nombre: get_val(&doc, fields.nombre),
            segundo_nombre: get_val(&doc, fields.segundo_nombre),
            apellido: get_val(&doc, fields.apellido),
            segundo_apellido: get_val(&doc, fields.segundo_apellido),
