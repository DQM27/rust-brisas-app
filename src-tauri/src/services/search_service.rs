...
use crate::search::{initialize_index, get_index_writer, get_index_reader};
use crate::search::{index_contratista, update_contratista_in_index, delete_from_index, commit_index};
...
impl SearchService {
    ...
    pub async fn reindex_all_contratistas(&self, pool: &SqlitePool) -> Result<(), String> {
        ...
        // Indexar cada uno
        for (contratista, empresa_nombre) in contratistas {
