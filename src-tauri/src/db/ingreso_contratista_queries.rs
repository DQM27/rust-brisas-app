...
pub async fn insert(
    ...
    sqlx::query!(
        ...
        (id, contratista_id, cedula, nombre, apellido, empresa_nombre,
         ...
         gafete_numero, gafete_tipo, fecha_hora_ingreso, fecha_hora_salida, tiempo_permanencia_minutos,
