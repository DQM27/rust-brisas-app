...
pub async fn create_gafete(
    ...
    gafete_service::create_gafete(&pool, input).await.map_err(|e| e.to_string())
}
...
pub async fn create_gafete_range(
    ...
    gafete_service::create_gafete_range(&pool, input).await.map_err(|e| e.to_string())
}
...
pub async fn get_gafete(
    ...
    gafete_service::get_gafete(&pool, &numero, &tipo).await.map_err(|e| e.to_string())
}

#[tauri::command]
pub async fn get_all_gafetes(pool: State<'_, SqlitePool>) -> Result<GafeteListResponse, String> {
    gafete_service::get_all_gafetes(&pool).await.map_err(|e| e.to_string())
}
...
pub async fn get_gafetes_disponibles(
    ...
    gafete_service::get_gafetes_disponibles(&pool, tipo_enum).await.map_err(|e| e.to_string())
}
...
pub async fn is_gafete_disponible(
    ...
    gafete_service::is_gafete_disponible(&pool, &numero, &tipo).await.map_err(|e| e.to_string())
}
...
pub async fn update_gafete(
    ...
    gafete_service::update_gafete(&pool, numero, tipo, input).await.map_err(|e| e.to_string())
}
...
pub async fn delete_gafete(
    ...
    gafete_service::delete_gafete(&pool, numero, tipo).await.map_err(|e| e.to_string())
}
