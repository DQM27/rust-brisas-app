...
>
	<div class="{view === 'login' ? 'flex-1 pb-20' : ''} flex items-center justify-center w-full">
		{#if view === 'login'}
			...
			>
				...
				<div class="flex items-center justify-between px-6 py-3 border-b border-white/5 bg-white/5">
					<div class="flex flex-col">
						...
						<p class="text-[10px] text-secondary/60 uppercase tracking-widest font-semibold mt-0.5">
							Seguridad Requerida
						</p>
					</div>
					<button
