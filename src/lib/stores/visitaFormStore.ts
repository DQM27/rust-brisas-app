...
export const validacion = derived(visitaFormData, ($formData): ValidacionVisitaResult => {
...
export function updateField<K extends keyof VisitaFormData>(field: K, value: VisitaFormData[K]) {
