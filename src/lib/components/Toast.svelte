...
<div class="toast-container">
	<Toaster
		...
		toastOptions={{
			duration: 4000,
			style:
				'background: #2a2f32; color: #e9edef; border-radius: 12px; box-shadow: 0 2px 8px rgba(0, 0, 0, 0.4); padding: 12px 16px; font-size: 14px; min-width: 280px; max-width: 400px;',
