<script lang="ts">
	...
	let { show = $bindable(false), activeEntries = [], onSelect, onClose }: Props = $props();
                  ...
                  {i === highlightedIndex
							...
							>
								...
								<div class="flex-shrink-0 text-gray-500">
									<Search
										size={14}
										class={i === highlightedIndex ? 'text-white' : 'text-gray-500'}
									/>
								</div>
								...
								<div class="flex-1 min-w-0">
									...
									<div class="flex items-center gap-3 text-xs opacity-70 mt-0.5">
			...
			<div class="px-4 py-2 bg-black/20 border-t border-white/5 flex justify-between items-center">
				...
				<div class="flex items-center gap-3">
					<span class="text-[10px] text-gray-600 flex items-center gap-1">
						<kbd class="px-1.5 py-0.5 bg-black/40 rounded border border-white/10 text-[9px]"
							>ESC</kbd
						> Cancelar
					</span>
					<span class="text-[10px] text-gray-600 flex items-center gap-1">
						<kbd class="px-1.5 py-0.5 bg-black/40 rounded border border-white/10 text-[9px]">↑↓</kbd
						> Navegar
					</span>
				</div>
			</div>
