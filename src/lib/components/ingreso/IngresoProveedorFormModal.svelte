		...
		>
			...
			>
				<div>
					...
					<p class="text-sm text-secondary mt-1">Registrar entrada de proveedor</p>
				</div>
				<button
					onclick={handleClose}
					type="button"
							...
							<div class="space-y-2 mb-4">
								<div class="flex items-center">
									...
									<span class="text-primary font-semibold text-sm"
										...
										{validationResult?.apellido || selectedPerson.apellido}</span
									>
								</div>
								<div class="flex items-center">
									<span
										...
										>Cédula</span
									>
									<span class="text-primary font-mono text-sm">{selectedPerson.cedula}</span>
								</div>
								<div class="flex items-center">
									<span
										class="text-[12px] font-bold uppercase tracking-wider text-gray-500 w-20 shrink-0"
									...
									{#if validationResult.tieneGafetesPendientes}
										{#each validationResult.alertasGafete as alerta}
											...
											>
												...
												<div>
													<p class="font-semibold text-xs font-mono uppercase tracking-tight">
														Alerta de Seguridad
													</p>
