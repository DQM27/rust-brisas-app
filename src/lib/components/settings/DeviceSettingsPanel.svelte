...
>
	<div class="mb-6">
		...
		<p class="text-secondary mt-1">Configura la identidad de este dispositivo.</p>
	</div>
	...
	<div class="grid gap-6 max-w-2xl">
		...
		<div class="card-base p-5 bg-surface-2/50 border border-white/5">
			<div class="flex items-start gap-4">
				...
				<div class="flex-1">
					<h3 class="text-lg font-semibold text-primary mb-1">ID del Dispositivo</h3>
		...
		<div class="card-base p-6 space-y-6">
			...
			<div class="space-y-2">
				...
				<div class="relative">
					...
					/>
					<Monitor size={18} class="absolute left-3 top-1/2 -translate-y-1/2 text-secondary" />
				</div>
				<p class="text-xs text-secondary/60">Nombre visible en reportes y logs.</p>
			</div>
			...
			<div class="space-y-2">
				...
				<div class="relative">
					<input
						...
						class="w-full bg-surface-1 border border-white/10 rounded-lg px-4 py-2.5 pl-10 text-primary focus:outline-none focus:ring-2 focus:ring-blue-500/50 transition-all placeholder:text-white/20"
					/>
					<MapPin size={18} class="absolute left-3 top-1/2 -translate-y-1/2 text-secondary" />
				</div>
				<p class="text-xs text-secondary/60">Ayuda a identificar dónde está instalado el equipo.</p>
			</div>
