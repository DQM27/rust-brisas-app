...
<div class="flex flex-col gap-6">
		...
		<div class="flex items-start gap-3 mb-4">
			...
			<div class="flex-1">
				<div class="flex items-center justify-between mb-1">
					<h4 class="font-medium text-primary">Bloqueo por Inactividad Local (App)</h4>
				...
				<p class="text-sm text-secondary mb-3">
					Bloquea la app por falta de interacción interna (incluso si está visible)
				</p>
				...
				{#if $sessionSettings.enableAppLock}
					<div class="space-y-3 ml-1 pl-3 border-l-2 border-amber-500/30">
						<!-- Timeout Duration -->
						<div>
							<label for="app-lock-timeout" class="block text-sm font-medium text-secondary mb-2">
								Tiempo sin usar la app: <span class="text-amber-500 font-semibold"
	...
	<div class="rounded-lg border border-emphasis bg-surface-1 p-4">
		<div class="flex items-start gap-3 mb-4">
			...
			<div class="flex-1">
				<div class="flex items-center justify-between mb-1">
					<h4 class="font-medium text-primary">Protector de Pantalla Interactivo</h4>
					<label class="relative inline-flex items-center cursor-pointer">
						<input
							type="checkbox"
				...
				<p class="text-sm text-secondary mb-3">
					Muestra el panel de bienvenida en pantalla completa después de inactividad
				</p>
					...
					<div class="space-y-3 ml-1 pl-3 border-l-2 border-emphasis">
						...
						<div class="flex items-center justify-between p-3 rounded-lg bg-surface-2">
							<div class="flex items-center gap-2">
								...
								<div>
									<div class="text-sm font-medium text-primary">Requiere contraseña para salir</div>
	...
	<div class="rounded-lg border border-emphasis bg-surface-1 p-4">
		<div class="flex items-start gap-3 mb-4">
			<div class="flex items-center justify-center w-10 h-10 rounded-lg bg-red-500/10">
			...
			<div class="flex-1">
				...
				<p class="text-sm text-secondary mb-3">
					Cierra sesión completamente y elimina todas las pestañas después de inactividad prolongada
				</p>
				...
				{#if $sessionSettings.enableCompleteTimeout}
					<div class="space-y-3 ml-1 pl-3 border-l-2 border-red-500/30">
						<!-- Timeout Duration -->
						<div>
							<label for="complete-timeout" class="block text-sm font-medium text-secondary mb-2">
						...
						{#if $sessionSettings.enableScreensaver && completeMinutes <= screensaverMinutes}
							...
							>
								...
								<div class="text-xs text-amber-600 dark:text-amber-400">
									El cierre de sesión debe ocurrir después del protector de pantalla. Se ajustará
									automáticamente.
								</div>
							</div>
						{/if}
	...
	<div class="rounded-lg border border-blue-500/20 bg-blue-500/5 p-4">
		<div class="flex items-start gap-3">
			...
			<div class="text-sm text-secondary">
				<p class="font-medium text-primary mb-1">💡 Comportamiento de la sesión</p>
				<ul class="space-y-1 list-disc list-inside">
					<li>
						La app <strong>no recordará tu sesión</strong> al cerrarse y abrirse de nuevo
					</li>
					<li>El contador de inactividad se reinicia con cualquier interacción (mouse, teclado)</li>
					<li>Puedes habilitar uno, ambos, o ningún timeout según tus necesidades</li>
