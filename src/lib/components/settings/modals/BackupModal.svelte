<script lang="ts">
  ...
  // AG Grid
  let gridApi: GridApi<BackupEntry> | null = null;
  ...
  async function handleCleanup() {
    const confirmed = await confirm(
      ...
      { title: "Confirmar Limpieza", kind: "warning" },
    );
    if (!confirmed) return;
    ...
    >
      ...
      <div class="flex-1 overflow-y-auto p-6 space-y-5">
        ...
        <div class="bg-[#161b22] p-4 rounded-md border border-gray-700">
          ...
          <div class="flex items-center gap-4 mb-4">
            ...
            <span class="text-sm text-gray-300"
              >{configEnabled ? "Activado" : "Desactivado"}</span
            >
        ...
        <div class="grid grid-cols-2 gap-4">
          ...
          <div class="bg-[#161b22] p-4 rounded-md border border-gray-700">
            <h3
              class="text-sm font-semibold text-white flex items-center gap-2 mb-2"
            >
