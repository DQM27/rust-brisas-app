		...
		>
			...
			>
				<div class="flex items-center gap-2">
					...
					<h2 class="text-lg font-semibold text-gray-900 dark:text-white">Actualizaciones</h2>
				</div>
				<button
					onclick={onClose}
			...
			<div class="p-6">
				<div class="flex flex-col gap-4">
					...
					<p class="text-sm text-gray-500 dark:text-gray-400">
						Busca nuevas actualizaciones disponibles desde el servidor oficial. La aplicación se
						reiniciará si se instala una nueva versión.
					</p>
				</div>
			</div>
