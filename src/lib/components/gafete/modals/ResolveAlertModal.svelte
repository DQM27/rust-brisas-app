						...
						<div class="space-y-2">
							...
							<div class="grid grid-cols-1 gap-2 pt-1">
								...
								<div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
									<Calendar size={14} />
									<span
										>Reportado el: <strong class="text-gray-700 dark:text-gray-300"
				...
				<div class="space-y-4">
					<div>
						<label for="notasResolucion" class={labelClass}>
							Notas de Resolución <span class="text-gray-400 font-normal">(Obligatorio)</span>
						</label>
						<textarea
							id="notasResolucion"
							bind:value={notas}
						...
						<p class="mt-1 text-xs text-gray-400">
							Describa brevemente cómo se resolvió la pérdida (devolución física, pago, reposición,
							etc).
						</p>
					</div>
				</div>
