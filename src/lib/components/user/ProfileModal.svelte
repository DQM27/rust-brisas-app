	...
	>
		...
		>
			...
			<div class="relative flex-none">
				...
				<div class="h-32 bg-surface-3 relative overflow-hidden border-b border-surface">
					<div
				...
				<div class="px-8 -mt-24 relative z-20 flex items-center justify-between gap-4">
					<div class="flex items-center gap-5 flex-1 min-w-0">
						...
						<div class="pb-2 flex-1 min-w-0">
							...
							<div class="flex items-center gap-2 text-secondary text-sm mt-0.5">
								<span
			...
			<div class="flex-1 overflow-y-auto p-8 pt-10">
				<div class="bg-surface-1 p-6 rounded-xl border border-surface shadow-inner-surface">
					<div class="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
						<!-- Personal Info -->
						{#if user.cedula || user.fechaNacimiento}
							<div class="space-y-6">
								<h3 class="text-[10px] font-bold text-primary/40 uppercase tracking-[0.2em] mb-4">
									...
									{#if user.direccion}
										<div class="flex items-start gap-4 group">
											...
											<div>
												...
												<dd class="text-sm font-medium text-primary mt-0.5 leading-relaxed">
													{user.direccion}
												</dd>
											</div>
										</div>
