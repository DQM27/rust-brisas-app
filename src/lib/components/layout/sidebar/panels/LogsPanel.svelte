...
<div class="panel-section">
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('dashboard', 'Registros del Sistema'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('user-list', 'Actividad de Usuarios'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('reportes-list', 'Historial de Reportes'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
