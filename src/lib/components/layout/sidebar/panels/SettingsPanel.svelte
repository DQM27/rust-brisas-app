...
<div class="panel-section">
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('general-settings', 'Ajustes Generales'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('visual-settings', 'Ajustes Gráficos'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('export-settings', 'Configuración de Exportación'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('backup-settings', 'Copias de Seguridad'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('roles-settings', 'Roles y Permisos'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
...
<div class="panel-section">
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('session-settings', 'Gestión de Sesión'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
	...
	<button
		class="panel-item"
		on:click={executeAndClose(() => openView('update-settings', 'Actualizaciones'))}
		on:keydown={(e) =>
			handleKeydown(
				e,
