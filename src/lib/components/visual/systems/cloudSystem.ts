...
import { CLOUD_CONFIG, getTimeOfDay, randomRange, seededRandom } from '../constants';
 ...
 */
function generateAtmosphericBlobs(
	seed: number
 ...
 */
function createAtmosphericCloud(
	index: number,
