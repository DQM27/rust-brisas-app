  ...
  >
    <div class="flex items-center gap-2">
      <div class="p-1 bg-[#2da44e]/10 rounded border border-[#2da44e]/20">
        <Lock class="w-4 h-4 text-[#2da44e]" />
      </div>
    ...
    <div class="flex items-center gap-1">
      <button
        ...
        class="p-1.5 text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 rounded transition-colors"
        title="Minimizar"
      >
        <Minus class="w-4 h-4" />
      </button>
      <button
        type="button"
        onclick={exitApp}
        class="p-1.5 text-gray-400 hover:bg-red-500 hover:text-white rounded transition-colors"
        title="Cerrar"
      >
        <X class="w-4 h-4" />
      </button>
