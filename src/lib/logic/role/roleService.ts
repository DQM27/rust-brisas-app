 ...
 * Actualizar rol
 */
export async function updateRole(id: string, input: UpdateRoleInput): Promise<ServiceResult<RoleResponse>> {
    try {
...
function parseError(err: any): string {
    ...
    if (typeof err === 'string') {
        ...
        if (/CannotModifySystemRole/i.test(err)) return 'Solo el superusuario puede modificar roles del sistema.';
